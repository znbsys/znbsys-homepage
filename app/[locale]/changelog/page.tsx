...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const page = await getLegalPage(locale, 'changelog');
  ...
  return {
    ...
    alternates: buildAlternates('/changelog/', origin),
  };
}
...
export default async function ChangelogPage({ params }: Props) {
  ...
  return <LegalArticle content={legal.changelog} labels={legal.labels} showReleases />;
}
